      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <div className="hidden items-center gap-3 md:flex">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full border border-slate-800 bg-slate-900/90 px-4 py-2 text-sm font-medium text-slate-200 transition hover:border-cyan-400 hover:text-white"
          >
            Courses
            <svg className={`h-4 w-4 transition-transform ${coursesOpen ? 'rotate-180' : ''}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <Link
            href="/playground"
            className={`inline-flex items-center rounded-full border px-4 py-2 text-sm font-medium transition ${pathname === '/playground' ? 'border-cyan-400 bg-cyan-500/10 text-cyan-200' : 'border-transparent text-slate-300 hover:border-slate-700 hover:bg-slate-900/80 hover:text-white'}`}
          >
            Playground
          </Link>
          ...
          <a
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-slate-800 bg-slate-900 text-slate-300 transition hover:border-cyan-400 hover:text-cyan-200"
          >
