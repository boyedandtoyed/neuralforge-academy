      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6">
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <a
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-slate-900 text-slate-300 transition-all duration-200 hover:border-teal-400 hover:text-teal-200 hover:shadow-[0_0_20px_rgba(0,212,200,0.18)]"
          >
